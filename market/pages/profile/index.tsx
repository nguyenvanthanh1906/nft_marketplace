                  ...
                  <div className="de_tab_content">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                          <div className="nft__item">
                            <div className="de_countdown" data-year={2021} data-month={11} data-day={16} data-hour={8} />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                          <div className="nft__item">
                            <div className="de_countdown" data-year={2021} data-month={11} data-day={14} data-hour={8} />
                            <div className="author_list_pp">
                              <a href="author.html">                                    
                                <img className="lazy" src="images/author/author-1.jpg" alt="" />
                                <i className="fa fa-check" />
                    ...
                    <div className="tab-3">
                      <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6">
                          <div className="nft__item">
                            <div className="de_countdown" data-year={2021} data-month={11} data-day={6} data-hour={8} />
                            <div className="author_list_pp">
                              <a href="author.html">                                    
                        ...
                        <div className="col-lg-3 col-md-6">
                          <div className="nft__item">
                            <div className="de_countdown" data-year={2021} data-month={11} data-day={29} data-hour={8} />
                            <div className="author_list_pp">
                              <a href="author.html">                                    
